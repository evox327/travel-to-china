    ...
    try {
      ...
      const staticGuides: Guide[] = [
        ...
        },
        {
          ...
          author: { name: 'Zhang Mei', image: '/images/avatar-zhang-mei.jpg' },
        ...
        },
        {
          ...
          author: { name: 'Wang Hao', image: '/images/avatar-wang-hao.jpg' },
          category: 'adventure',
        ...
        },
        {
          ...
          author: { name: 'Chen Yu', image: '/images/avatar-chen-yu.jpg' },
          category: 'budget',
          tags: ['Budget', 'Backpacking', 'Transportation', 'Accommodation'],
          coverImage: '/images/budget-travel.jpg',
          readTime: 20,
          views: 32180,
          likes: 1245,
